 ...
 *
 * Este archivo es usado por el script de creación de wp-config.php durante el 
 * Instalación. Usted no tiene que utilizar el sitio web, usted puede copiar este archivo 
 * A "wp-config.php" y rellenar los valores.
 *
 * @package WordPress
 */
